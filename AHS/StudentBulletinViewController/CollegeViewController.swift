...
class CollegeViewController: UIViewController, UIScrollViewDelegate {
    ...
    var collegePHPURL = "http://ahsmobile.ausd.net:8080/AHS-Mobile/bulletin-json.jsp?category=2"
    
    override func viewDidAppear(_ animated: Bool) {
        JSONToTextView(urlstring: collegePHPURL)
    }
    ...
    @objc func refreshAction(sender: AnyObject!){
        ...
        self.JSONToTextView(urlstring: collegePHPURL)
        print("refreshed")
