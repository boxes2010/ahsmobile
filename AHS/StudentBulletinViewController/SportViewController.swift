...
class SportViewController: UIViewController, UIScrollViewDelegate {
    ...
    var sportsPHPURL = "http://ahsmobile.ausd.net:8080/AHS-Mobile/bulletin-json.jsp?category=5"
    
    override func viewDidAppear(_ animated: Bool) {
        JSONToTextView(urlstring: sportsPHPURL)
    }
