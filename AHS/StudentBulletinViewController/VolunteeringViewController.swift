...
class VolunteeringViewController: UIViewController, UIScrollViewDelegate {
    ...
    var volunteeringPHPURL = "http://ahsmobile.ausd.net:8080/AHS-Mobile/bulletin-json.jsp?category=3"
    
    override func viewDidAppear(_ animated: Bool) {
        JSONToTextView(urlstring: volunteeringPHPURL)
    }
